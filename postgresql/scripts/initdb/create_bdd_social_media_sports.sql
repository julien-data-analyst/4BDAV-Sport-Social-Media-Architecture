...
CREATE TABLE IF NOT EXISTS "Sensors_Metrics_Activities" (
	"id" TEXT NOT NULL UNIQUE,
	"activity_id" TEXT NOT NULL,
	"sensor_metric_id" TEXT NOT NULL,
	"upload_date" TIMESTAMP NOT NULL DEFAULT current_timestamp,
	PRIMARY KEY("id")
);
...
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Sensors_Metrics_Activities"
ADD FOREIGN KEY("activity_id") REFERENCES "Activity"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Sensors_Metrics_Activities"
ADD FOREIGN KEY("sensor_metric_id") REFERENCES "Sensors_Metrics"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Activity_Aggregation_Metrics"
